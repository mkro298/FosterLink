...
const Community = ({ user, userID }) => {
  ...
  const backend = async () => {
    ...
    try {
      const response = await fetch(`${backendUrl}/pull_all`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleNewPostChange = (e) => {
    ...
    setNewPost({ ...newPost, [name]: files ? files[0] : value });
  };
          ...
          {showModal && (
            <div className="modal-overlay" onClick={() => setShowModal(false)}>
              <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                />
                <textarea name="content" placeholder="Content" value={newPost.content} onChange={handleNewPostChange} />
                <input type="file" name="file" onChange={handleNewPostChange} />
